...
{/* SEÇÃO CONTATO */}
      <section id="contato" className="contact-section">
        ...
        <div className="contact-info">
          ...
          <p><strong>Telefone/WhatsApp:</strong> <a href="tel:+5519983768189" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent-silver)', textDecoration: 'underline' }}>(19) 98376-8189</a></p>
